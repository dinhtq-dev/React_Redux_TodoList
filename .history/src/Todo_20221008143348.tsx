...
const Todo = () => {
    ...
    const editUpdateListTodo = () => {
        currentTodo && setTodoList(prev => (
            [
                ...prev.filter(item=>item.id !== currentTodo.id),
                currentTodo
            ]
        ))
        setCurrentTodo(null);
    ...
    return (
        <div className="todo-container">
            ...
            <AddTodo editUpdateListTodo={editUpdateListTodo} addListTodo={addListTodo} currentTodo={currentTodo} editTodo={editCurrentTodo}></AddTodo>
